...
<body class=" h-100  text-white bg-dark">
    ...
    <form method="POST" action="" id="regform">
        <table border=0 align="center">
            ...
            <tr>
                <td><label>Enter Your Batch:</label></td>
                <td><input type="text" class="form-control" name="batch" placeholder="Your Batch No"></td>
            </tr>
            <tr>
    ...
    if (!empty($_POST['fname'])) {
        if (isset($_POST['btn'])) {
            ...
            $email = $_POST['email'];
            $password = $_POST['pass'];
            $query = "INSERT INTO student(user_id, name, batch, email, password) VALUES('$userid','$fname','$btch','$email','$password')";
