...
<body class=" h-100 bg-dark">
    ...
    <div id="content-wrap">
        ...
        margin-left: auto;
        margin-right: auto;">
                <h1 class="display-2 " style="">Features</h1><br>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 border p-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <h5 class="card-title"><a href="question.html">Create a Question</a>
                                    </h5>
                                    <p class="card-text">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 border p-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <h5 class="card-title"><a href="easytouse.html">Easy to use</a>
                                    </h5>
                                    <p class="card-text">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 border p-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <h5 class="card-title"><a href="rules.html">Rules and Regulations</a>
                                    </h5>
                                    <p class="card-text">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 border p-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <h5 class="card-title"><a href="qbank.html">Question bank</a>
                                    </h5>
                                    <p class="card-text">
