    ...
    ?>
     ...
     <div id="content-wrap">
        ...
        margin-right: auto;">
                ...
                <h2 class="display-4" style="text-align: center;">Welcome <span style="color: "><?php echo $fnam;?></span> to our Online Test System</h2>
...
<div class="container" id="exam">
        ...
        <div class="row ">
            ...
            <div class="col-12">
                <hr class="my-4">
<hr class="my-4">
               <h1 class="display-2 " style="text-align: center; color: white;">Exam Management System</h1>
        ...
        <div class="b">
              <div class="buttons">
                ...
                <a href="question.php">
            <button>Create a Question</button> </a>

            <a href="exam.php">
            <button class="btn2">Create an Exam Paper</button>
        </a>

         <a href="#">
            <button class="btn2">Result Management</button>
        </a>
